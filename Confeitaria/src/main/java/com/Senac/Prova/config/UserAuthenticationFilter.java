package com.Senac.Prova.config;


import com.Senac.Prova.entity.Usuario;
import com.Senac.Prova.repository.UsuarioRepository;
import com.Senac.Prova.service.JwtTokenService;
import com.Senac.Prova.service.UserDetailsImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                Usuario usuario = usuarioRepository.findByLogin(subject).get(); // Busca o usuário pelo email (que é o assunto do token)
